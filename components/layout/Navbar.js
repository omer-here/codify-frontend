...
import { LoginButton, LogoutButton, RegisterButton, User } from "../../app/user";
...
function Navbar() {
  return (
    ...
    >
      ...
      <div className=" flex flex-row justify-center gap-4 mx-4 text-transparent bg-clip-text bg-gradient-to-r from-slate-500 from-10% via-slate-600 via-30% to-gray-300 to-90% ">
        <p>Home</p>
        <p>About Us</p>
        <p>Features</p>
        <p>Solution</p>
